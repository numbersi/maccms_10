...
class Maccms extends Taglib {
	...
	protected $tags = [
        ...
        'comment'=>['attr' =>'order,by,start,num,paging,pageurl,id,pid,rid,mid,half'],
        'gbook'=>['attr' =>'order,by,start,num,paging,pageurl,rid,half'],
        'role'=>['attr' =>'order,by,start,num,paging,pageurl,id,ids,not,rid,actor,name,level,letter,half,timeadd,timehits,time','cachetime'],
        'actor'=>['attr' =>'order,by,start,num,paging,pageurl,id,ids,not,area,sex,name,level,letter,half,timeadd,timehits,time','cachetime'],
        ...
        'vod' => ['attr' =>'order,by,start,num,id,ids,not,paging,pageurl,type,class,tag,area,lang,year,level,letter,half,rel,version,state,tv,weekday,timeadd,timehits,time,hitsmonth,hitsweek,hitsday,hits','cachetime'],
