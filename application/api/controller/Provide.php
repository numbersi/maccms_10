...
class Provide extends Base
{
    ...
    public function vod()
    {
        ...
        $order = 'vod_time desc';
        $field = 'vod_id,vod_name,type_id,"" as type_name,vod_en,vod_time,vod_remarks,vod_pic,vod_play_from,vod_down_from,vod_time';
    ...
    public function vod_json($res)
    {
        ...
        foreach($res['list'] as $k=>&$v){
            ...
            elseif(!empty($v["vod_pic"]) && substr($v["vod_pic"],0,4)!="http"){
    ...
    public function art()
    {
        ...
        foreach($res['list'] as $k=>&$v){
            ...
            elseif(!empty($v["art_pic"]) && substr($v["art_pic"],0,4)!="http"){
